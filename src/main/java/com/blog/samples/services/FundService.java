...
import com.blog.samples.dao.FundDAO;
...
public class FundService {
	...
	/**
	 * Gets all funds in DB.
	 *
	 * @return the all funds in DB
	 */
	@Transactional
	public List<Fund> getAllFundsDB() {
		
		List<FundEntity> listFundsEntity = fundDAO.listFund();
		
		List<Fund> fundList = new ArrayList<Fund>();
		
		for(FundEntity entity:listFundsEntity){
			Fund fund = new Fund();
			fund.setFundId(entity.getFundId());
			fund.setBidPrice(entity.getBidPrice());
			fund.setFundDescription(entity.getFundDescription());
			fund.setOfferPrice(entity.getOfferPrice());
